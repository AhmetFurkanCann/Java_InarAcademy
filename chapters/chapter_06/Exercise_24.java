...
public class Exercise_24 {
    public static void main(String[] args) {
        ...
        System.out.println("Current Date is : " + yearAndMonthAndDay);
        System.out.println("Current Time : " + getCurrentTime(totalMilliseconds));
    ...
    public static String getYearAndMonthAndDay(long totalMilliseconds) {
        ...
        return year + " " + dayNumber + " " + monthName + " " +  dayName;
    }
